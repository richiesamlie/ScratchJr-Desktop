...
const { DEBUG, DEBUG_LOAD_DEVTOOLS, debugLog } = require('./logging');
...
function createWindow(dataStore) {
...
module.exports = { createWindow, getWindow, saveWindowState, destroyWindow };
